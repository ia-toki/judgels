...
class ContestContestantRoleCheckerIntegrationTests extends AbstractRoleCheckerIntegrationTests {
    ...
    void register() {
        ...
        assertThat(checker.canRegister(USER, contestAStarted)).isFalse();
        ...
        assertThat(checker.canRegister(CONTESTANT, contestAStarted)).isFalse();
        ...
        assertThat(checker.canRegister(SUPERVISOR, contestAStarted)).isFalse();
        ...
        assertThat(checker.canRegister(MANAGER, contestAStarted)).isFalse();
