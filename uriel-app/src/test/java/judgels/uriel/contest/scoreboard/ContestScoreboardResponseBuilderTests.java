...
class ContestScoreboardResponseBuilderTests {
    ...
    void before() {
        ...
        responseBuilder = new ContestScoreboardResponseBuilder(userService, mapper);
    }

    @Test
    void build_response() throws IOException {
        ...
        assertThat(responseBuilder.buildResponse(raw, ContestStyle.ICPC, ContestScoreboardType.OFFICIAL)).isEqualTo(
