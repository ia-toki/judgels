...
public final class ItemEssayConfAdapter implements BundleItemConfAdapter {
    ...
    public Form generateForm(FormFactory formFactory) {
        return formFactory.form(ItemEssayConfForm.class);
    }
    ...
    public Form generateForm(FormFactory formFactory, String conf, String meta) {
        ...
        return formFactory.form(ItemEssayConfForm.class).fill(itemForm);
    }
    ...
    public Form bindFormFromRequest(FormFactory formFactory, Http.Request request) {
        return formFactory.form(ItemEssayConfForm.class).bindFromRequest();
    }
