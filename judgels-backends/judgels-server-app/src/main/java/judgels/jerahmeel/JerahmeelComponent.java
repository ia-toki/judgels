...
import tlx.jerahmeel.tasks.DeleteProblemTask;
import tlx.jerahmeel.tasks.MoveProblemToChapterTask;
import tlx.jerahmeel.tasks.MoveProblemToProblemSetTask;
import tlx.jerahmeel.tasks.UploadDuplexSubmissionsToAwsTask;
...
@Component(modules = {
        ...
        // Features
        judgels.jerahmeel.tasks.JerahmeelTaskModule.class,
