package judgels.contest.problem;
...
public class ContestProblemResource {
    ...
    @Produces(APPLICATION_JSON)
    @UnitOfWork(readOnly = true)
    public judgels.api.contest.problem.programming.ContestProblemWorksheet getProgrammingProblemWorksheet(
        ...
        return new judgels.api.contest.problem.programming.ContestProblemWorksheet.Builder()
    ...
    @Produces(APPLICATION_JSON)
    @UnitOfWork(readOnly = true)
    public judgels.api.contest.problem.bundle.ContestProblemWorksheet getBundleProblemWorksheet(
            @Context HttpServletRequest req,
            @Context UriInfo uriInfo,
            @HeaderParam(AUTHORIZATION) Optional<AuthHeader> authHeader,
            @PathParam("contestJid") String contestJid,
        ...
        return new judgels.api.contest.problem.bundle.ContestProblemWorksheet.Builder()
                .defaultLanguage(problemInfo.getDefaultLanguage())
                .languages(problemInfo.getTitlesByLanguage().keySet())
                .problem(problem)
                .totalSubmissions(totalSubmissions)
