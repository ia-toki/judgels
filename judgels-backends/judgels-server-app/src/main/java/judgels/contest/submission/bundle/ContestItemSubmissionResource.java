...
public class ContestItemSubmissionResource {
    ...
    @Inject @ContestItemSubmissionStore protected ItemSubmissionStore submissionStore;
    ...
    @Inject @ContestItemSubmissionRegrader protected ItemSubmissionRegrader itemSubmissionRegrader;
