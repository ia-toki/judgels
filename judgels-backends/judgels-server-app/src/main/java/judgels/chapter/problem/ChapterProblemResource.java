package judgels.chapter.problem;
...
import judgels.api.chapter.problem.ChapterProblemWorksheet;
import judgels.api.chapter.problem.ChapterProblemsResponse;
...
public class ChapterProblemResource {
    ...
    public ChapterProblemWorksheet getProblemWorksheet(
        ...
        if (problemInfo.getType() == ProblemType.PROGRAMMING) {
            ...
            return new judgels.api.chapter.problem.programming.ChapterProblemWorksheet.Builder()
            ...
            return new judgels.api.chapter.problem.bundle.ChapterProblemWorksheet.Builder()
                    .defaultLanguage(problemInfo.getDefaultLanguage())
                    .languages(problemInfo.getTitlesByLanguage().keySet())
                    .problem(problem)
                    .previousResourcePath(previousAndNextResourcePaths.get(0))
