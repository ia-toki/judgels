...
public class OutputOnlyWithSubtasksGradingConfigAdapterTests extends BaseGradingConfigAdapterTests {
    private OutputOnlyWithSubtasksGradingConfigAdapter adapter;

    @BeforeEach
    void before() {
        adapter = new OutputOnlyWithSubtasksGradingConfigAdapter();
    }
