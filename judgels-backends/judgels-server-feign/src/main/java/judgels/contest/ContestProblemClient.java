...
public interface ContestProblemClient {
    ...
    @Headers("Authorization: Bearer {token}")
    judgels.api.contest.problem.programming.ContestProblemWorksheet getProgrammingProblemWorksheet(
            @Param("token") String token,
            @Param("contestJid") String contestJid,
    ...
    @Headers("Authorization: Bearer {token}")
    judgels.api.contest.problem.bundle.ContestProblemWorksheet getBundleProblemWorksheet(
            @Param("token") String token,
            @Param("contestJid") String contestJid,
            @Param("problemAlias") String problemAlias);
}
