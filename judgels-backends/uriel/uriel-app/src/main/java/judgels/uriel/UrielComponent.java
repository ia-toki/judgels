...
import judgels.uriel.contest.submission.programming.ContestProgrammingSubmissionResource;
...
public interface UrielComponent {
    ...
    ContestProgrammingSubmissionResource contestProgrammingSubmissionResource();
