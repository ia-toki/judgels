...
MODULES = OrderedDict([
    ...
    (':sandalphon-commons', {':play-commons', ':api', ':judgels-commons:judgels-service-persistence', ':sandalphon:sandalphon-api', ':sandalphon:sandalphon-client', ':gabriel:gabriel-engines', ':sealtiel:sealtiel-api'}),
